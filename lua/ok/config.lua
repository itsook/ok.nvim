...
M.highlights_base = function (colors)
  return {
    ...
    Comment = { guifg = vim.o.background == 'dark' and colors.color15 or colors.color7 },
    Folded = { guifg = colors.color4, guibg = colors.background },
    FoldColumn = { guifg = colors.color4, guibg = colors.background },
    LineNr = { guifg = vim.o.background == 'dark' and colors.color15 or colors.light_bg, guibg = colors.background },
